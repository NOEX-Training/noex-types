...
export interface IAPPurchase {
    ...
    data: {
        ...
        productSku: string;
        productType: 'consumable' | 'non_consumable' | 'renewable_subscription' | 'subscription';
        pruchaseDate: string;
        quantity: number;
        reciept: string;
        /**
    ...
    id: string;
    type: 'purchase' | 'refund' | 'user_id_update' | 'subscription_renewal' | 'subscription_renewal_retry' | 'subscription_grace_period_expire' | 'subscription_product_change' | 'subscription_replace' | 'subscription_cancel' | 'subscription_uncancel' | 'subscription_expire' | 'subscription_pause' | 'subscription_pause_enabled' | 'subscription_pause_disabled';
    version: string;
}
